...
\begin{center}    
    \section*{SOLUTIONS}
\end{center}
\subsection*{Exercise 5.10.1 (a)}
Let's analyze the values taken by the boolean function $f(x_1, x_2) = x_{1} \land \neg x_{2}$. We get the following table:\\
\\
...
\end{tabular}\\
\\
It's easy to see that the function $A(x_1, x_2) := \mathbf{\varphi}((1,-1)\cdot(x_1, x_2) -\frac{1}{2}) = \begin{cases}
1 \text{ if } x_1 - x_2 \geq \frac{1}{2} \\ 0 \text{ if } x_1 - x_2 < \frac{1}{2}\\
\end{cases}$ is an adequate choice because it can learn the 
points presented in the above. This in turn means that the desired neuron is given by the quadruple
$((-1,x_1,x_2),(1,-1,\frac{1}{2}),A,(0,0,1,0))$.

\subsection*{Exercise 5.10.1 (b)}                                                                                                  
Let's analyze the values taken by the boolean function $f(x_1, x_2) = x_{1}\land \neg x_{2}$. We get the following table:\\        
\\                                                                                                                                 
\begin{tabular}{|c c c c|}                                                                                                         
    \hline                                                                                                                         
...
\end{tabular}\\                                                                                                                    
\\                                                                                                                                 
It's easy to see that the function $\mathbf{\varphi}(x_1, x_2) = $ is an adequate choice because it can learn the       
points presented in the above. This in turn means that $(\{0,1\}^{2},\mathbf{I}_{\{x_1 + x_2 > 0\}}(x_1, x_2), ,\{0,1\}^{2})$

\subsection*{Exercise 5.10.1 (c)}                                                                                             
Let's analyze the values taken by the boolean function $f(x_1) = \neg x_{1}$. We get the following table:\\   
\\                                                                                                                            
\begin{tabular}{|c c|}                                                                                                    
    \hline                                                                                                                    
    $x_1$ & $\neg x_{1}$ \\ [0.5ex]                                                            
...
\end{tabular}\\                                                                                                               
\\                                                                                                                            
It's easy to see that the function $\mathbf{I}_{\{x_1 + x_2 > 0\}}(x_1, x_2)$ is an adequate choice because it can learn the  
points presented in the above. This in turn means that $(\{0,1\}^{2},\mathbf{I}_{\{x_1 + x_2 > 0\}}(x_1, x_2), ,\{0,1\}^{2})$

\subsection*{Exercise 5.10.1 (d)}                                                                                             
Let's analyze the values taken by the boolean function $f(x_1, x_2) = x_{1}\land \neg x_{2}$. We get the following table:\\   
\\                                                                                                                            
\begin{tabular}{|c c c c|}                                                                                                    
    \hline                                                                                                                    
...
\end{tabular}\\
\\
On the other hand, analyzing the boolean function ...\\
\begin{tabular}{|c c c c|}                                           
    \hline                                                           
    $x_1$ & $x_2$ & $\neg x_2$ & $x_{1}\lor \neg x_{2}$ \\ [0.5ex]   
    \hline                                                           
