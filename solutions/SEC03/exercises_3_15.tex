...
\subsection*{3.15.5 (a)}
Given that $p(x)$ is a distribution, it follows that $p(X)$  as a r.v satisffies the inequality $0 \leq p(X) \leq 1$. Taking logs to both sides of the inequality $p(X) \leq 1$ we obtain:\\
\begin{proof}
    \begin{equation*}
        \begin{aligned}
            a
...
\subsection*{3.15.6}
This an inmediate consecuence of exercise $3.15.5$. We have:\\
\begin{proof}
    \begin{equation*}
        \begin{aligned}
